...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light">
      ...
      {auth.token !== null && auth.userData.role ==='user' && <div className="container d-flex align-items-center">
        <Link className="navbar-brand text-center" to="/">
          <img className='img-fluid' src={logo} alt="logo" />
          <div className='brand d-inline align-middle'>
            <span className='mx-2'>V E H I C O O L</span>
      ...
      {auth.token !== null && auth.userData.role ==='admin' && <div className="container d-flex align-items-center">
        <Link className="navbar-brand text-center" to="/">
          <img className='img-fluid' src={logo} alt="logo" />
          <div className='brand d-inline align-middle'>
            <span className='mx-2'>V E H I C O O L</span>
